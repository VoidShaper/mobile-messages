...
case class MessageServiceHeadersResponse(items: Seq[MessageHeader])

object MessageServiceHeadersResponse {
  ...
  implicit val reads = Json.reads[MessageServiceHeadersResponse]

...
case class GetMessagesResponseItem(id: String,
                                   subject: String,
                                   validFrom: LocalDate,
...
object GetMessagesResponseItem {

  import play.api.libs.functional.syntax._
  import play.api.libs.json.{Json, Reads, _}
  import uk.gov.hmrc.play.controllers.RestFormats

  implicit val writes: Writes[GetMessagesResponseItem] = Json.writes[GetMessagesResponseItem]

  def fromAll(messageHeaders: Seq[MessageHeader])(encrypter: Encrypter): Seq[GetMessagesResponseItem] = {
